...
public class AlgoritmosGrafos {
	 ...
	 * Nombre
	 * Si es dirigido
	 * Grados de entrada y salida de los v�rtices
	 * Orden
	 * Tama�o
	...
	public static void estadoGrafo(Grafo grafo) {
		...
		for(int i=0; i<grafo.obtenerNumVertices(); ++i)
			System.out.println("Vertice " + i + ": GIn= " + grafo.gradoIn(i) + 
	 ...
	 * @param ma Tipo de implementaci�n deseada: true genera un grafo con Matriz de Adyacencias, con false genera un grafo con Listas de Adyacencias
	 * @return El grafo generado a partir de la matriz de adyacencias
	 */
	public static Grafo getGrafo(int[][] mAdy, boolean ma){
		Grafo grafo;
		int n = mAdy.length;
		if(ma) //crea un grafo seg�n el tipo, se indica que es dirigido, pero es la disposici�n de los arcos es lo que lo define.
	...
	/**
	 * M�todo que retorna la multiplicaci�n de dos matrices de enteros C=AB
	...
	/**
	 * M�todo para determinar el n�mero de caminos de una longitud dada entre dos v�rtices
	 * @param g Grafo
	 * @param m Longitud de los caminos
	 * @param i V�rtice origen
	 * @param j V�rtice destino
	 * @return N�mero de caminos de longitud m desde i y hasta j, o -1 si el grafo no est� implementado
	 */
	...
	/**
	 * M�todo recursivo para determinar el n�mero de caminos de una longitud dada entre dos v�rtices
	 * @param g Grafo
	 * @param m Longitud de los caminos
	 * @param i V�rtice origen
	 * @param j V�rtice destino
	 ...
	 * @param g Grafo
	 * @param m Longitud de los caminos
	 * @return Matriz con el n�mero de caminos de longitud m para cada par de v�rtices
	 */
	...
	/**
	 * Determina el n�mero de bucles que tiene el Grafo grafo
	 * @param grafo Grafo cualquiera implementado por Listas o Matriz de adyacencias
	 * @return El n�mero de bucles del grafo
	 */
	...
	public static int[][] matrizT(int[][] matriz) {
		int numFilas = matriz.length; //n�mero de filas de la matriz
		int numCols;
		int[][] mT = new int[numFilas][];

		for (int fila = 0; fila < numFilas; ++fila) {
			numCols = matriz[fila].length; //n�mero de columnas por fila, no necesariamente es regular
	...
	/**
	 * Obtiene el tipo de implementaci�n del grafo dado
