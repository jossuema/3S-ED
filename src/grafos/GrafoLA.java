...
//  ----------------------------------------
	...
	public GrafoLA(boolean d) { // Grafo vacío
		maxNodos = numVertices = 0;
		dirigido = d;
	}

	@SuppressWarnings("unchecked")
	public GrafoLA(int n, boolean d) { // construye una array de listas de tamaño n con 0 vértices.
		dirigido = d;
		maxNodos = n;
		numVertices = 0;
...
//  --------------------
	...
	public void insertaVertice(int n) {// n: numero de vertices que quiero añadir al grafo
...
//  ----------------------------------------
	...
	public int tamanno() { // Número de arcos, se cuenta el número de nodos de las listas.
		int tm = 0;
		for (int i = 0; i < numVertices; i++) {
